    ...
    const benefits = [
        {
            ...
            title: 'Desain Profesional, Tanpa Ribet',
            description: 'Lupakan software desain yang berat dan butuh spek dewa. Kamu bisa bikin visual keren hanya dengan drag-and-drop.',
            gradient: 'from-blue-500/10 via-purple-500/10 to-pink-500/10',
        },
        {
            icon: <Award className="h-7 w-7" />,
            title: 'Skill Paling Dicari di Era Digital',
            description:
                'Coba cek platform freelance atau lowongan kerja. Hampir semua brand, UKM, dan content creator butuh skill desain Canva. Ini skill yang wajib dimiliki semua orang.',
            gradient: 'from-emerald-500/10 via-teal-500/10 to-cyan-500/10',
        },
        {
            icon: <Heart className="h-7 w-7" />,
            title: '1 Skill untuk Ribuan Kebutuhan',
            description:
                'Kamu bisa bikin poster, presentasi, motion graphics, resume, sampai website. Satu skill ini bisa kamu pakai untuk apa pun, baik untuk kerjaan, kuliah, dll',
            gradient: 'from-pink-500/10 via-purple-500/10 to-red-500/10',
        },
        {
            icon: <Briefcase className="h-7 w-7" />,
            title: 'Ubah Kreativitas Jadi Cuan',
            description:
                'Di kelas ini, kamu akan diajarkan cara membuat produk digitalmu sendiri pakai Canva. Ubah skill-mu jadi aset yang bisa ngasilin passive income pertamamu.',
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="animate-fade-in mb-16 text-center" style={{ animationDelay: '200ms', animationFillMode: 'both' }}>
                    ...
                    <h2 className="text-foreground mb-6 text-4xl font-bold lg:text-6xl">
                        Kamu Wajib <span className="text-primary">Belajar Canva Sekarang</span>
                    </h2>
                    <p className="text-muted-foreground mx-auto max-w-3xl text-lg leading-relaxed">
                        Di era visual ini, skill canva bukan lagi pilihan, tapi kebutuhan. Ini 4 alasan krusial kenapa Canva adalah jawaban paling
                        worth it untuk kamu.
                    </p>
                </div>
                    ...
                    <div className="animate-fade-in lg:col-span-5" style={{ animationDelay: '400ms', animationFillMode: 'both' }}>
                        <div className="relative">
                            ...
                            <div className="border-border/20 shadow-primary/5 relative overflow-hidden rounded-3xl border shadow-2xl">
                                <img
                                    src="/storage/landing/canvathumb2.webp"
                ...
                <div className="animate-fade-in mt-16 text-center" style={{ animationDelay: '1400ms', animationFillMode: 'both' }}>
                    <div className="from-primary/10 via-primary/5 to-accent/10 border-primary/20 rounded-2xl border bg-gradient-to-r p-8 backdrop-blur-xl">
                        <h3 className="text-foreground mb-4 text-xl font-bold">Udah Tahu Pentingnya, Kan?</h3>
                        <p className="text-muted-foreground leading-relaxed">
                            Sekarang kamu tahu ini skill wajib. Pertanyaannya, mau sampai kapan jadi penonton? Sekarang kesempatan kamu untuk mulai
                            dapetin cuan tambahan dari dunia digital dengan canva!
                        </p>
                    </div>
                </div>
            </div>
