        ...
        courses: [
            {
                ...
                thumbnail: '/storage/landing/bonusCourses/bonus-course-1.webp',
            },
            {
                id: 2,
                ...
                thumbnail: '/storage/landing/bonusCourses/bonus-course-2.webp',
            },
            {
                id: 3,
                ...
                thumbnail: '/storage/landing/bonusCourses/bonus-course-3.webp',
            },
            {
                id: 4,
                ...
                thumbnail: '/storage/landing/bonusCourses/tanda-tanya.webp',
            },
            {
                id: 5,
    ...
    standard: [
        {
            id: 1,
            badge: 'Bonus #01',
            title: 'E-Book "Bongkar Rahasia Jago Desain Grafis Cuma Pake Canva"',
            value: 'Rp 79.000',
            description:
                'Kamu bakal dapet E-Book eksklusif “Bongkar Rahasia Jago Desain Grafis Cuma Pake Canva” Isinya full tips, teknik, dan mindset yang biasa dipake para desainer pro tapi dikemas ringan biar kamu gampang ikutin.',
            image: '/storage/landing/bonus-section/Bonus-1.webp',
            features: ['50+ Template Premium', 'Color Grading Presets', 'Custom Transitions'],
        },
        {
            id: 2,
            badge: 'Bonus #02',
            title: 'E-Book "Panduan 30 Hari Jadi Konten Kreator"',
            value: 'Rp 49.000',
            description:
                'Bonus ini bakal bantu kamu mulai dari nol sampai bisa jadi konten kreator yang konsisten dalam 30 hari. Isinya panduan step-by-step dan tips biar kamu bisa jadi konten creator sukses dalam 30 hari. Cocok banget buat kamu yang pengen punya personal branding kuat di media sosial.',
            image: '/storage/landing/bonus-section/Bonus-2.webp',
            features: ['60 Menit Review', 'Feedback Detail', 'Action Plan'],
        },
        {
            id: 3,
            badge: 'Bonus #03',
            title: 'Grup Komunitas Canva Creator Di Indonesia',
            value: 'Rp 499.000',
            description:
                'Kamu akan mendapatkan akses ke grup komunitas sesama pembelajar Canva dan akan dibimbing oleh mentor untuk menjawab pertanyaan yang kamu bingungkan.',
            image: '/storage/landing/bonus-section/Bonus-3.webp',
            features: ['60 Menit Review', 'Feedback Detail', 'Action Plan'],
        },
        {
            id: 4,
            badge: 'Bonus #04',
            title: 'Konsultasi 1-on-1 dengan Mentor',
            value: 'Rp 599.000',
            description:
                'Kamu bisa melakukan konsultasi gratis seputar Canva melalui Chat dan akan dijawab langsung oleh mentor ataupun via zoom jika memungkinkan. ',
            image: '/storage/landing/bonus-section/Bonus-4.webp',
            features: ['60 Menit Review', 'Feedback Detail', 'Action Plan'],
        },
        {
            id: 5,
            ...
            value: 'Rp 299.000',
            description:
                'Selain materi yang kamu dapatkan, tak lengkap rasanya jika kamu tidak praktek. Kamu akan disediakan tugas latihan yang dapat diakses di website, dan tugas tersebut di upload di form yang sudah disediakan. Atau kamu dapat mengirimkannya langsung di grup WA/Telegram. Mentor akan mengoreksi dan memberikan masukkan dari karya yang kamu buat. ',
            image: '/storage/landing/bonus-section/Bonus-5.webp',
            features: ['60 Menit Review', 'Feedback Detail', 'Action Plan'],
        },
        {
            id: 6,
            badge: 'Bonus #06',
            title: 'Grup Ekslusif: Materi Setiap Hari',
            value: 'Rp 399.000',
            description:
                'Jika di grup support kamu akan diberikan pendampingan berupa diskusi, di grup eksklusif ini kamu juga akan mendapatkan value lebih, yaitu info seputar dunia desain dan Canva. Kamu akan dikirimkan informasi seperti info lomba desain, info kerja kreatif, bahkan info freelance desain dan berkesempatan bekerjasama langsung dengan tim Pondok Grafis untuk meng-handle beberapa project desain',
            image: '/storage/landing/bonus-section/Bonus-6.webp',
            features: ['60 Menit Review', 'Feedback Detail', 'Action Plan'],
        },
    ],
};
...
const bonusImages = [
    { id: 1, image: '/storage/landing/bonus-section/Bonus-1.webp' },
    { id: 2, image: '/storage/landing/bonus-section/Bonus-2.webp' },
    { id: 3, image: '/storage/landing/bonus-section/Bonus-3.webp' },
    { id: 4, image: '/storage/landing/bonus-section/Bonus-4.webp' },
];
        ...
        <section className="relative overflow-hidden py-20 lg:py-32">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-16 space-y-8 text-center">
                    ...
                    <div className="animate-fade-in space-y-4" style={{ animationDelay: '200ms', animationFillMode: 'both' }}>
                        <h2 className="text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl">
                            <span className="text-foreground block">Eits, Belum Selesai!</span>
                            <span className="mt-2 block">
                                {/* <span className="text-foreground"> </span> */}
                                <span className="from-primary via-primary/80 to-primary bg-gradient-to-r bg-clip-text text-transparent">
                                    Ini Bonus Spesial Untukmu
                                </span>
                            </span>
                        </h2>
                        <p className="text-muted-foreground mx-auto max-w-3xl text-xl leading-relaxed">
                            Selain materi utama, kamu juga bakal dapet bonus senilai jutaan rupiah ini untuk melengkapi skill canvamu
                        </p>
                    </div>
                    ...
                    >
                        {bonusImages.map((bonus) => (
                            <div
                                key={bonus.id}
                                className="group from-card/50 to-card/20 border-border/50 hover:border-primary/50 relative aspect-[4/3] cursor-pointer overflow-hidden rounded-xl border bg-gradient-to-br transition-all duration-500 hover:scale-105"
                ...
                {/* <div className="py-20 lg:py-32">
                    <div
                        className="from-card/50 via-card/30 to-background border-border/50 relative overflow-hidden rounded-3xl border bg-gradient-to-br p-8 lg:p-12"
                        data-aos="fade-up"
                        data-aos-delay="200"
                    >
