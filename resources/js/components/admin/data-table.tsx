    ...
    return (
        <div className="space-y-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="bg-gradient-to-r from-cyan-400 via-cyan-600 to-blue-500 bg-clip-text text-3xl font-bold text-transparent">
                                {title}
                            </h1>
                        </div>
            ...
            <div className="relative max-w-md">
                <Search className="text-foreground absolute top-1/2 left-4 h-5 w-5 -translate-y-1/2 transform" />
                <Input
            ...
            <Card className="from-primary/10 via-primary/20 to-primary/10 border-primary/30 hidden overflow-hidden border bg-gradient-to-br shadow-2xl backdrop-blur-sm lg:block">
                            ...
                            <tr className="border-primary/20 border-b">
                                {columns.map((column) => (
                                    <th
                                        ...
                                        className="text-foreground p-6 text-left text-sm font-semibold tracking-wider uppercase"
                                    >
                                        {column.sortable ? (
                                            <button
                                ...
                                <th className="text-primary p-6 text-left text-sm font-semibold tracking-wider uppercase">Operations</th>
                            </tr>
                        </thead>
                        <tbody>
                            {paginatedData.map((item, index) => (
                                <tr key={index} className="group border-primary/20 hover:bg-primary/20 border-b transition-all duration-300">
                                    {columns.map((column) => (
                                        <td key={String(column.key)} className="text-foreground p-6">
