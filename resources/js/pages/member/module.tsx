                ...
                <div className="relative">
                    ...
                    <div className="relative mx-auto max-w-7xl px-4 pt-8 pb-12">
                        ...
                        <div className="mb-8">
                            ...
                            <h1 className="mb-4 text-4xl font-bold text-white lg:text-5xl">{module.name}</h1>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="w-full">
                            ...
                            <div className="h-3 w-full overflow-hidden rounded-full bg-neutral-800 backdrop-blur-sm">
                                <div
                                    className="from-primary animate-glow-pulse h-full rounded-full bg-gradient-to-r via-blue-700 to-blue-900 transition-all duration-1000"
