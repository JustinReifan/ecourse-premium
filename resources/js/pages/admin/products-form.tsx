    ...
    return (
        <AdminLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="relative p-6">
                <div className="mb-6">
                    <Button variant="outline" onClick={() => router.get('/admin/products')} className="border-zinc-700 text-white hover:bg-zinc-800">
                        <ArrowLeft className="mr-2 h-4 w-4" />
                        Back to Products
                    </Button>
                </div>

                <Card className="border-zinc-700/50 bg-gradient-to-br from-zinc-900/95 via-zinc-800/50 to-zinc-900/95">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2 bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-2xl font-bold text-transparent">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                <div className="space-y-2">
                                    <Label htmlFor="title" className="font-mono text-sm tracking-wider text-gray-300 uppercase">
                                        Product Title
                                    </Label>
                                    <Input
                                        id="title"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="price" className="font-mono text-sm tracking-wider text-gray-300 uppercase">
                                        Price (Rp)
                                    </Label>
                                    <Input
                                        id="price"
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                <div className="space-y-2">
                                    <Label htmlFor="affiliate_commission_rate" className="font-mono text-sm tracking-wider text-gray-300 uppercase">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setData('affiliate_commission_rate', e.target.value ? parseFloat(e.target.value) : null)
                                        }
                                        className="border-zinc-700/50 bg-zinc-800/50 text-white backdrop-blur-sm focus:border-cyan-400"
                                ...
                                <div className="space-y-2">
                                    <Label className="font-mono text-sm tracking-wider text-gray-300 uppercase">Default Product</Label>
                                    <div className="flex items-center space-x-2 rounded-lg border border-zinc-700/50 bg-zinc-800/30 p-4">
                                        <Checkbox
                                            id="is_default"
                            ...
                            {data.type === 'ecourse' && (
                                <div className="space-y-2">
                                    <Label className="font-mono text-sm tracking-wider text-gray-300 uppercase">Select Courses</Label>
                                        ...
                                        {courses.length === 0 ? (
                                            ...
                                            courses.map((course) => (
                                                <div key={course.id} className="flex items-center space-x-2">
                                                    ...
                                                    />
                                                    <label htmlFor={`course-${course.id}`} className="text-sm text-gray-300">
                                                        {course.name}
                                                    </label>
                                                </div>
                                            ))
                            ...
                            {(data.type === 'ebook' || data.type === 'template') && (
                                <div className="space-y-2">
                                    <Label htmlFor="file" className="font-mono text-sm tracking-wider text-gray-300 uppercase">
                                        Upload File
                                    </Label>
                                    <Input
                                        id="file"
                            ...
                            {data.type === 'affiliate_link' && (
                                <div className="space-y-2">
                                    <Label htmlFor="external_url" className="font-mono text-sm tracking-wider text-gray-300 uppercase">
                                        External URL
                                    </Label>
                                    <Input
                                        id="external_url"
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    {thumbnailPreview && (
                                        <div className="mt-4">
                                            <Label className="font-mono text-sm tracking-wider text-gray-300 uppercase">Preview</Label>
                                            <img
