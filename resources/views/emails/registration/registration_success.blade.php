...
<body
    ...
    <div
        ...
        <p style="font-size: 16px; color: #4b5563;">
            Seneng banget akhirnya kamu resmi bergabung di <strong>{{ $product_name }}</strong>.
        </p>

        <p style="font-size: 16px; color: #4b5563;">
            Aku mau kabarin kalau pembayaran kamu udah beres diterima, dan akun kamu sekarang udah <strong>aktif
                sepenuhnya</strong>. Sekarang waktunya buat mulai belajar dan <strong>upgrade skill</strong> kamu! 🚀
        </p>
